...
namespace minimesh {
    namespace mohe {
        ...
        class ISM_Vertex_Optimizer {
        public:

            /* default constructor */
            ISM_Vertex_Optimizer() = default;

            /* Get the optimization results*/
            ISM_VO_OutputData res() { return _res; }
             ...
             * */
            ISM_VO_OutputData optimizeVertex(const ISM_VO_InputData &data) {
                _opt_data = data;
        ...
        private:
            ...
            ISM_VO_InputData _opt_data{};

            // results of the optimization process
            ISM_VO_OutputData _res{};
